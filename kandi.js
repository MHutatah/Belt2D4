...
function animate() {
  if (!stop) {
    ...
    // draw the score
    ctx.fillText('Score: ' + score + 'm', canvas.width - 240, 30);
    ctx.fillText('Name: ' + 'Mohammed Alghamdi', canvas.width - 240, 45);
    ctx.fillText('Class: ' + 'DevOps online', canvas.width - 240, 60);
